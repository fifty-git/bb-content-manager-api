...
import { GetAllDataAccess, GetProductsDataAccess } from "~/core/application/groups/use-cases/read";
...
export class GroupsService {
  ...
  GetProductsDataAccess = new GetProductsDataAccess();
  ...
  constructor() {
    ...
    this.GetProductsDataAccess.run = this.GetProductsDataAccess.run.bind(this.GetProductsDataAccess);
